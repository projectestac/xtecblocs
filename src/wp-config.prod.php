...
define('WPCACHEHOME', '/dades/blocs/html/wp-content/plugins/wp-super-cache/'); //Added by WP-Cache Manager
define('DB_NAME', 'blocs');

/** MySQL database username */
define('DB_USER', 'xtecblocs');

/** MySQL database password */
define('DB_PASSWORD', '################');

/** MySQL hostname */
define('DB_HOST', 'myblocs');
...
define('DB_NUMS',100); /** HyperDB additional databases */
...
define('DOMAIN_CURRENT_SITE', 'blocs.xtec.cat');
