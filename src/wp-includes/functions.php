	...
	foreach ( $wp_tables as $table ) {
		...
		if ( in_array( $table, $tables ) ) {
			...
			if ( defined('WP_REPAIRING') )
				return true;
			// Die with a DB error.
			$wpdb->error = sprintf( /*WP_I18N_NO_TABLES*/'Una o més taules de la base de dades no estan disponibles. La base de dades necessita ser <a href="%s">reparada</a>.'/*/WP_I18N_NO_TABLES*/, 'maint/repair.php?referrer=is_blog_installed' );
			dead_db();
		}
	}
