...
if ( function_exists('register_sidebar_widget') )
    register_sidebar_widget(__('Search','andreas09'), 'widget_andreas09_search');
...
if ( function_exists('register_sidebar_widget') )
    register_sidebar_widget(__('RSS Subscribe','andreas09'), 'widget_andreas09_subscribe');	 
...
if ( function_exists('register_sidebar_widget') )
    register_sidebar_widget(__('Meta','andreas09'), 'widget_andreas09_meta');
...
if ( function_exists('register_sidebar_widget') )
    register_sidebar_widget(__('Recent Posts','andreas09'), 'widget_andreas09_recent_entries');
 
 

	 
// WP-Andreas09 Colour Options
load_theme_textdomain('andreas09', get_template_directory() . '/languages');
...
<div class="wrap">
<h1>WP-Andreas09</h1>
<p>WP-Andreas09 <?php _e('was designed by','andreas09'); ?> <a href="http://andreasviklund.com">Andreas Viklund</a> and Ported to WordPress by <a href="http://webgazette.co.uk">Ainslie Johnson</a>.</p>
