			...
			<div class="entrytext">
				...
				<p class="postmetadata alt">
					<small>
						...
						<?php _e('You can follow any responses to this entry through the','andreas09'); ?> <?php comments_rss_link('RSS 2.0'); ?> <?php _e('feed'); ?>. 
						
						<?php if (('open' == $post-> comment_status) && ('open' == $post->ping_status)) {
							// Both Comments and Pings are open ?>
							<?php _e('You can'); ?> <a href="#respond"><?php _e('leave a response','andreas09'); ?></a>, <?php _e('or'); ?> <a href="<?php trackback_url(true); ?>" rel="trackback"><?php _e('trackback','andreas09'); ?></a> <?php _e('from your own site','andreas09'); ?>.
