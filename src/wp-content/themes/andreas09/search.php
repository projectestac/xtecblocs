...
<?php include (TEMPLATEPATH . '/right-sidebar.php'); ?>
	...
	<?php if (have_posts()) : ?>
		...
		<p><a href="<?php the_permalink() ?>" rel="bookmark" title="Permanent Link to <?php the_title(); ?>"><?php _e('Read the rest of this post...','andreas09'); ?></a></p>
				<p class="category"><?php _e('Posted in','andreas09'); ?> <?php the_category(', ') ?> | <?php edit_post_link(__('Edit'), '', ' | '); ?>  <?php comments_popup_link(__('No Comments &#187;','andreas09'), __('1 Comment &#187;','andreas09'), __('% Comments &#187;','andreas09')); ?></p>
			</div>
