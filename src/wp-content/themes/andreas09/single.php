...
<h2><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php _e('Permanent Link to','andreas09'); ?> <?php the_title(); ?>"><?php the_title(); ?></a></h2>
		...
		<div class="entrytext">
			...
			<p class="postmetadata">
				 		<?php _e('This entry was posted on','andreas09'); ?> <?php the_time(__('l, F jS, Y','andreas09')) ?> <?php _e('at','andreas09'); ?> <?php the_time() ?>
						<?php _e('and is filed under','andreas09'); ?> <?php the_category(', ') ?>.
						<?php _e('You can follow any responses to this entry through the','andreas09'); ?> <?php comments_rss_link('RSS 2.0','andreas09'); ?> <?php _e('feed','andreas09'); ?>. 
