...
<?php 	/* Widgetized sidebar, if you have the plugin installed. */
	...
	<?php wp_list_pages('title_li=' . __('Pages:', 'classic')); ?>
	<?php wp_list_bookmarks('title_after=&title_before='); ?>
	<?php wp_list_categories('title_li=' . __('Categories:', 'classic')); ?>
 <li id="search">
 ...
 <li id="meta"><?php _e('Meta:', 'classic'); ?>
	<ul>
		...
		<li><a href="http://wordpress.org/" title="<?php _e('Powered by WordPress, state-of-the-art semantic personal publishing platform.', 'classic'); ?>"><abbr title="WordPress">WP</abbr></a></li>
		<?php wp_meta(); ?>
	</ul>
 </li>
<?php endif; ?>
