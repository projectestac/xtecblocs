...
$stbv_opt = get_site_option('plugin_simple_tb_validation2');
...
add_action('network_admin_menu', 'stbv_add_options_to_admin');
...
function stbv_add_options_to_admin() {
	...
	add_submenu_page('settings.php','Simple TB Validation', 'Simple TB Validation', 'manage_network_options', basename(__FILE__), 'stbv_adminOptions');
...
function stbv_adminOptions() {
	...
	add_site_option('plugin_simple_tb_validation2', $stbv_opt, 'Simple Trackback Validation Plugin Options');
	...
	*/
	...
	if (isset($_POST['submit']) ) {
		...
		update_site_option('plugin_simple_tb_validation2', $stbv_opt_update);
...
function stbv_log_addentry($logmsg) {
	...
	if ($log = get_site_option('plugin_simple_tb_validation2_log')) {
	...
	*/
	...
	//************ FI
		...
		update_site_option('plugin_simple_tb_validation2_log', $log);
		...
		*/
		...
		add_site_option('plugin_simple_tb_validation2_log', 'empty', 'Simple Trackback Validation Plugin: Log', 'no');
...
function stbv_log_display() {
	...
	if ($stbv_opt['stbv_enablelog'] == '1') {
		...
		$log = get_site_option('plugin_simple_tb_validation2_log');
		...
		*/
		...
		update_site_option('plugin_simple_tb_validation2_log', 'empty');
