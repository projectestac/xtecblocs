...
{
    add_submenu_page('settings.php', 'Mail', 'Mail', 'manage_network_options', 'ms-mail', 'xtec_mail_network_options');
}

/**
 * Displays plugin network options page.
 */
function xtec_mail_network_options()
{
	switch ( $_GET['action'] ) {
		case 'siteoptions':
	...
	?>
	<div class="wrap">
		<form method="post" action="?page=ms-mail&action=siteoptions">
...
if ( !function_exists('wp_mail') ) {
	function wp_mail( $to, $subject, $message, $headers = '', $attachments = array() ) {
		...
		$noreply = 'xtecblocs-noreply@xtec.cat';
		
		//load the mailsender
		$mailsender = new mailsender('XTECBLOCS', $noreply, 'educacio', get_site_option('xtec_mail_environment'), $xtec_mail_log, $xtec_mail_debug,'');
