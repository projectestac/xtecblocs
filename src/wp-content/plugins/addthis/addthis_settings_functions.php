...
?>
        <tr>
            <td id="<?php echo $name ?>" colspan="2">
              <fieldset>  
				<legend>&nbsp; 
				<?php _e("Choose the sharing tool to display",'addthis_trans_domain'); ?>
				<b>
				<?php if ($name == 'above') { _e('above','addthis_trans_domain'); }
				else if ($name == 'below') { _e('below','addthis_trans_domain'); } ?>
				</b>
				<?php _e("the post:", 'addthis_trans_domain') ?>								
				&nbsp;</legend>
                ...
                echo "<div class='$name"."_option select_row $class mt20'><span class='radio mt4'><input $checked type='radio' value='custom' name='addthis_settings[$name]' id='$name"."_custom_button' /></span> " . __('Build your own','addthis_trans_domain') . "<div class='clear'></div></div>";
                ...
                echo "<li class='nocheck'><span class='at_custom_label'>" . __('Size','addthis_trans_domain') . ":</span><select name='addthis_settings[$name"."_custom_size]'><option value='16' $custom_16 >16x16</option><option value='32' $custom_32 >32x32</option></select><br/><span class='description'>" . __('The size of the icons to display','addthis_trans_domain') . "</span></li>";
                echo "<li><input $do_custom_services class='at_do_custom'  type='checkbox' name='addthis_settings[$name"."_do_custom_services]' value='true' /><span class='at_custom_label'>" . __('Services to always show:','addthis_trans_domain') . "</span><input class='at_custom_input' name='addthis_settings[$name"."_custom_services]' value='$custom_services'/><br/><span class='description'>" . __("Enter a comma-separated list of <a href='//addthis.com/services'>service codes</a>",'addthis_trans_domain') . " </span></li>";
                echo "<li><input type='checkbox' $do_custom_preferred class='at_do_custom'  name='addthis_settings[$name"."_do_custom_preferred]' value='true' /><span class='at_custom_label'>" . __('Automatically personalized:','addthis_trans_domain') . "</span>
                ...
                echo "</select><br/><span class='description'>" . __('Enter the number of automatically user-personalized items you want displayed','addthis_trans_domain') . "</span></li>";
               $custom_more = ( $custom_more ) ? 'checked="checked"' : '';
                
                echo "<li><input $custom_more type='checkbox' class='at_do_custom' name='addthis_settings[$name"."_custom_more]' value='true' /><span class='at_custom_label'>" . __('More','addthis_trans_domain') . "</span><br/><span class='description'>" . __('Display our iconic logo that offers sharing to over 330 destinations','addthis_trans_domain') . "</span></li>";
                echo "</ul></div>";
                    ...
                    echo "<div class='$name"."_option select_row $class '><span class='radio mt4'><input $checked type='radio' value='custom_string' name='addthis_settings[$name]' id='$name"."_custom_string' /></span> " . __('Custom button','addthis_trans_domain') . "<div class='clear'></div></div>";
                    ...
                    echo '</div>';
                ?>
				<div class="select_row description"><span class='radio mt0'><input type="radio" name="addthis_settings[<?php echo $name; ?>]" <?php echo ('none' == $option) ? 'checked="checked"' : '';?> value='none' /></span><?php _e('None','addthis_trans_domain');?></div>
				<p><a class="<?php echo $name;?>_option" href="#<?php echo $name;?>_more" id="<?php echo $name;?>_more"><?php _e('More options', 'addthis_trans_domain' ); ?></a></p>
