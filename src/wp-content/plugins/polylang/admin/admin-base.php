...
class PLL_Admin_Base extends PLL_Base {
	...
	public function __construct( &$links_model ) {
		...
		// XTEC ************ ELIMINAT - Change load plugin textdomain with wordpress action and moved to agora-functions.php - 2017.02.21 @xaviernietosanchez
	...
	public function add_menus() {
		...
		foreach ( $tabs as $tab => $title ) {
			...
			// XTEC ************ AFEGIT - Display only for xtecadmin - 2017.02.21 @xaviernietosanchez
