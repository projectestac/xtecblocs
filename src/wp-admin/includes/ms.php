...
//2013.03.05 @jmiro227
			...
			$errors->add( 'user_email', __( "<strong>ERROR</strong>: El correu electrònic que heu introduït no és vàlid. Només els usuaris XTEC poden fer servir adreces de correu electrònic @xtec.cat." ), array( 'form-field' => 'email' ) );
			return;
                }
