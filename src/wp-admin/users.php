...
case 'promote':
	...
	foreach ( $userids as $id ) {
		...
		//XTEC ************ AFEGIT - Només els usuaris XTEC poden ser administradors
		//2011.05.06 @fbassas
		if ( !xtec_user_can($id,'be_administrator') && ($_REQUEST['new_role'] == 'administrator') ){
			$update = "err_cant_be_admin";
			continue;
		}
		//************ FI
...
default:
	...
	if ( isset($_GET['update']) ) :
		...
		case 'err_admin_remove':
			...
			break;
		//XTEC ************ AFEGIT - Missatge d'error
		//2011.05.06 @fbassas
		case "err_cant_be_admin":
			$messages[] = '<div id="message" class="error"><p>Només els usuaris de la XTEC poden ser administradors del bloc.</p></div>';
			break;
		//************ FI
		}
	endif; ?>
